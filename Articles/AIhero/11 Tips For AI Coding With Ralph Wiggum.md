---
url: https://aihero.dev/tips-for-ai-coding-with-ralph-wiggum
---
...
I've used Ralph to add tests to my [AI Hero CLI](https://github.com/mattpocock/ai-hero-cli) and build features for my [course video manager](https://github.com/mattpocock/course-video-manager). Others have [built entire programming languages](https://github.com/ghuntley/ralph-lang) with it.
...
- GitHub issues or [Linear tasks](https://linear.app) (more on this later)
...
I ran Ralph to increase test coverage on my [AI Hero CLI](https://github.com/mattpocock/ai-hero-cli). The repo had internal commands - marked as internal but still user-facing (I use them). I wanted tests for everything.
...
Want to learn more about Ralph? I'll be publishing a lot more about autonomous AI coding on my [newsletter](https://aihero.dev/newsletter). Sign up to get notified when new articles drop.
